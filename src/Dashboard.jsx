            ...
            <div className="border-2 border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors">
              <div className="flex items-center justify-between mb-3">
                <div className="flex gap-2">
                  <span className="px-2 py-1 bg-red-100 text-red-500 rounded text-sm font-medium border border-red-200">Emergency Call</span>
                  <span className="px-2 py-1 bg-orange-100 text-orange-500 rounded text-sm font-medium border border-orange-200">High Priority</span>
                </div>
              </div>
              <div className="mb-3">
